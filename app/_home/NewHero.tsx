...
export default function NewHero() {
  return (
    <section className="relative min-h-[90vh] overflow-hidden w-screen grid items-center grid-cols-10 max-w-screen-xl ml-auto md:px-12 sm:px-8 px-4">
      <div className="col-span-10 w-fit relative row-start-1 col-start-1 z-10">
        <a
      ...
      <div className="col-span-5 col-start-7 row-start-1 w-[550px] pointer-events-none md:pointer-events-auto">
        <div
          style={{
            transform:
