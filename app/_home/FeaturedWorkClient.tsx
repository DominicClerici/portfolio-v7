    ...
    >
      <div className={`lg:py-8 pb-4 ${contentOrder}`}>
        <h2 className="text-3xl flex flex-col xs:flex-row xs:items-center gap-2 xs:mb-4 mb-2 font-display">
          ...
          <span className="items-center gap-2 xs:ml-4 lg:hidden flex">
            {children}
          </span>
        </h2>
        ...
        <span className="items-center gap-2 mt-8 hidden lg:flex">
          {children}
        </span>
      </div>
      <div
  ...
  return (
    <>
      ...
      >
        ...
        >
          View website
          <HoverArrow className="h-3 w-3" />
        </HoverButton>

        <HoverButton
          href="https://chromewebstore.google.com/detail/spring-tab-new-tab/kkoigocnngbcfpaodgdebmmighhlpkna"
          target="_blank"
          className="rounded-xl p-2.5 transition-colors hover:text-foreground duration-75 text-muted-foreground secondary-button"
        >
