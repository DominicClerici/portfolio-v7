  ...
  return (
    <header className="py-6 xs:px-8 px-4 lg:px-12 flex items-center z-10 justify-between absolute top-0 left-0 w-screen md:hidden">
      <div className="z-10 flex justify-between w-full">
        ...
        <button className="relative z-50 text-anim-2" onClick={() => setIsOpen(!isOpen)}>
      ...
      >
        ...
        <HeaderButton i={2} href="#featured" isOpen={isOpen} setIsOpen={setIsOpen}>
          Featured
        </HeaderButton>
        <HeaderButton i={3} href="#connect" isOpen={isOpen} setIsOpen={setIsOpen}>
          Connect
        </HeaderButton>
        <a
          style={{
          ...
          target="_blank"
          className={`${
            isOpen ? "translate-y-0 opacity-100 duration-300" : "translate-y-4 opacity-0 duration-150"
...
const HeaderButton = ({ children, href, isOpen, setIsOpen, i }: HeaderButtonInterface) => {
  return (
    <a
      style={{
